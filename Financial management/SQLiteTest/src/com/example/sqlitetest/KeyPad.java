...
public class KeyPad extends Activity implements OnClickListener{
	...
	private final String TAG="KeyPad";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.widget_digital_key);
		...
		if(this.getIntent().hasExtra("value"))
		{
			...
			value=_Intent.getStringExtra("value");
			myType=_Intent.getIntExtra(TranciationActivity.TYPE_FLAG, 1);
		}
	...
	public void onClick(View v) {
		...
		case R.id.done:
			...
			_Intent.putExtra(TranciationActivity.TYPE_FLAG, myType);
			_Intent.putExtra("value", value);
			Log.i("KeyPad", "value:"+value);
			this.setResult(RESULT_OK, _Intent);
			this.finish();
			break;
		default:
			int i = 0;
